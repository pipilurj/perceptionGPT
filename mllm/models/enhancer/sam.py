...
class MaskDecoder(nn.Module):
    ...
    def predict_masks(
        ...
        pos_src = torch.repeat_interleave(image_pe.unsqueeze(0), src.shape[0], dim=0).permute(0,3,2,1)
        b, c, h, w = src.shape

        # Run the transformer
        hs, src = self.transformer(src, pos_src, prompt_embeddings.unsqueeze(1))
