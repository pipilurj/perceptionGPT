...
class ResNet(nn.Module):
    def __init__(self, downblock, upblock, num_layers, n_classes):
        ...
        self.uplayer1 = self._make_up_block(upblock, 128, 1, stride=2)
        self.uplayer2 = self._make_up_block(upblock, 64, 2, stride=2)
        self.uplayer3 = self._make_up_block(upblock, 32, num_layers[2], stride=2)
        self.uplayer4 = self._make_up_block(upblock, 16, num_layers[1], stride=2)
